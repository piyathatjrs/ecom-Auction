...
$sql_update_bid = "INSERT INTO bid (user_ID, item_ID, 
user_Name, item_Name, bid_Date, bid_Price) 
VALUES ('$userid', '$itemid', '$username', '$itemname', '$currentdate', '$actual_price')";
mysqli_query($connect, $sql_update_bid);



// Update Items Table
$sql_update_item = "UPDATE items SET item_Close_Date = '$itemclosedate', item_Actual_Price = '$actual_price',
 user_Name = '$username', item_Status = 0 WHERE item_ID = '$itemid'";
