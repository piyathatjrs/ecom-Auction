...
<div class="container">
  ...
  <div id="message" style="display:none">
    ...
    <a href="./login_panel.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('login_button','','login_hover.png',1)"><img src="login.png" name="login_button" width="100" height="34" border="0" id="login_button" /></a>
    </div>
    ...
    <table>
    	...
    	<tr>
        	<td class="label"><h4>ยืนยันอีเมล</h4></td>
        ...
        <tr>
			...
			<div id="termswrap">
                ...
                <label id="lterms" for="terms">ตรวจสอบแล้วว่าข้อมูลถูกต้อง.</label><b style="padding:15px"></b>
			</div>
             <!-- /termswrap -->
	  		</td>
	  </tr>
