...
<body onload="MM_preloadImages('images/buttons/login_hover.png')">
  ...
  <div style="background: url(BG.png) top center repeat-x"  id="head-break">
    <div class="outer">
      <div id="login-reg">
        <a id="login" href="./login_panel.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('login_button','','login_hover.png',1)"><img src="login.png" name="login_button" width="100" height="34" border="0" id="login_button" /></a>
    ...
    <div class="container">
      <div id="loginBox">
        ...
        <form id="login-form" action="login.php" method="POST">
          ...
          <input type="image" src="login.png" value="Submit" name="submit" id="submit" />
        </form>
      </div>
      <div id="register-box">
